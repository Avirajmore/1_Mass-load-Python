...
title = "📂 Product Dupliate Files process 📂"
show_title(title)
print("\n❗️ Download product_ised file from Database first and rename it.")


query = "select Lineitem_Legacy_id__c,LastModifiedDate from OpportunityLineitem where Opportunity.Acquisition_Name__c ='Confluent' and Opportunity.RecordTypeId='012Ka0000015C9sIAE'"
pyperclip.copy(query.strip())
DOWNLOAD_FOLDER = os.path.expanduser("~/Downloads")                # change if needed (e.g. Downloads)
NEW_FILE_NAME = 'product_isc.csv'
choice = input("\n✅ product_isc query is copied to clipboard, Paste this Query in the WorkBench and download the csv file. Once done, type 'y' !")
...
class CompareCsv():
    def csv_compare(self):
        ...
        input_directory = os.path.expanduser("~/Downloads")
        ...
        df.rename(columns={"Lineitem_Legacy_id__c": "Id"}, inplace=True)
        ...
        # Write run stat
        csv_file_path = os.path.expanduser("~/Downloads/Confluent Load/Unimportant/Run_Stat.csv")
...
shutil.move(os.path.expanduser("~/Downloads/product_isc.csv"), os.path.expanduser("~/Downloads/Confluent Load/Duplicate Files/product_isc.csv"))
shutil.move(os.path.expanduser("~/Downloads/product_isced.csv"), os.path.expanduser("~/Downloads/Confluent Load/Duplicate Files/product_isced.csv"))
shutil.move(os.path.expanduser("~/Downloads/product_Record_Mismatch.csv"), os.path.expanduser("~/Downloads/Confluent Load/Duplicate Files/product_Record_Mismatch.csv"))

title = "📂 Product Dupliate Files Done 📂"
show_title(title)