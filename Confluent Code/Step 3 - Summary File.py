...
PROCESSED_FOLDER = os.path.expanduser("~/Downloads/Confluent Load/Success and Error files")
...
OUTPUT_FILE = os.path.expanduser(f"~/Downloads/Confluent Load/SUMMARY FILE - CONFLUENT PROD.xlsx")
