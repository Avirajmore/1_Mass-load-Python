...
query = "select Lineitem_Legacy_id__c,LastModifiedDate from OpportunityLineitem where Opportunity.Acquisition_Name__c ='HashiCorp' and Opportunity.RecordTypeId='012Ka0000015C9sIAE'"
